...
export const site = {
  name: "Realty Guruji",
  legalName: "Realty Guruji — Gurgaon Real Estate",
  tagline: "All Gurugram Property Expert",
  description:
    "Realty Guruji is Gurugram's trusted real estate consultancy led by Rahul Soni — 8+ years of expertise in rental, resale, builder floors and society flats across all of Gurgaon.",
  ...
  founder: {
    ...
    experienceYears: 8,
    bio: "Rahul Soni is the face of Realty Guruji — a Gurugram real estate consultant with over 8 years of on-ground experience helping families and investors find the right home or the right deal. From budget rentals to mid-segment resale, Rahul is known for honest advice, deep sector knowledge, and a transparent, no-pressure process.",
  },
  ...
  stats: [
    { value: "8+", label: "Years in Gurgaon" },
