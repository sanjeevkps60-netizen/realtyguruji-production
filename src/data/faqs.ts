export const generalFaqs: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Our rental focus is 2BHK and 3BHK flats from ₹20,000 to ₹35,000 per month. For resale, we specialise in mid-segment homes priced ₹1 Cr to ₹1.65 Cr, including builder floors and society flats.",
  },
  {
  ...
  {
    q: "How quickly can I get a property visit arranged?",
    a: "Usually within 24–48 hours. Share your requirement via the enquiry form or WhatsApp and Rahul will line up matching, verified options for a site visit.",
  },
];
